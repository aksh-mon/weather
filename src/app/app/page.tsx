...
import bgDark from "../app/bg/bg.jpg";
import bgLight from "../app/bg/bg2.jpg";
import {
  Sun,
  CloudRain,
  Cloud,
...
export default function WeatherPage() {
  ...
  const loadWeather = async (targetCity: string) => {
    if (weather && weather.city.toLowerCase() === targetCity.toLowerCase())
      return;
    setLoading(true);
  ...
  return (
    ...
    >
      <div className="w-full h-fit max-w-md shadow-md rounded-xl p-6 text-center border border-white/20 bg-white/20 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-center gap-2 mb-4 lg:sm">
