  ...
  return (
    <div className="text-center px-4 max-w-3xl mx-auto">
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white relative"
      >
        ...
        <br />
        <span className="text-gray-300 text-base sm:text-lg md:text-xl lg:text-2xl">
      ...
      <motion.p
        ...
        className="mt-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-400 italic"
      >
