...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  // store random positions once (avoid hydration mismatch)
            ...
            >
              ...
              {positions[idx + 1] &&
                psSymbols.map((symbol, i) => (
                  <motion.span
                    key={i}
                    className="absolute text-gray-200/50 text-xl font-bold select-none"
                    style={positions[idx + 1][i]}
                    animate={{
                      y: [0, -10, 0],
                      opacity: [0.3, 0.8, 0.3],
                      rotate: [0, 15, -15, 0],
